...
*/
        ...
        * */
        ...
        public static bool binarySearch2(int[] numerele, int nrCautat)
        {
            ...
            {
                int valMijloc = (indexStanga + indexDreapta) / 2;
                if (numerele[valMijloc] == nrCautat)
                {
                    return true;
                }
                else if (numerele[valMijloc] < nrCautat)
                {
                    indexStanga = valMijloc + 1;
                }
                else
                {
                    indexDreapta = valMijloc - 1;
                }
            }
            return false;
        }
